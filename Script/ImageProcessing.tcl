...
#
# ImageProcessing.tcl: Tcl script for re-creating project 'imageProcessingSystem'
#
# Generated by Vivado on Mon Feb 03 14:28:16 +0300 2025
...
#
# 1. This project restoration tcl script (ImageProcessing.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "D:/FPGA/Vivado Project/ImageProcessingSystem/imageProcessingSystem.srcs/sources_1/bd/hdl/imageProcessSystem_wrapper.vhd"
#
...
set _xil_proj_name_ "imageProcessingSystem"
...
set script_file "ImageProcessing.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../../../FPGA/Vivado Project/imageProcessingSystem"]"
...
set_property "ip_repo_paths" "[file normalize "$origin_dir/../../../FPGA/Vivado Project/ip_repo"]" $obj
...
set files [list \
 [file normalize "hdl/imageProcessSystem_wrapper.vhd" ]\
]
...
set file "hdl/imageProcessSystem_wrapper.vhd"
...
set obj [get_filesets sources_1]
set_property -name "top" -value "imageProcessSystem_wrapper" -objects $obj
...
# Proc to create BD imageProcessSystem
proc cr_bd_imageProcessSystem { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name imageProcessSystem
  ...
  if { $bCheckIPs == 1 } {
     set list_check_ips "\ 
  xilinx.com:user:ImageProcess:1.0\
  ...
  connect_bd_intf_net -intf_net ImageProcess_0_m_axis [get_bd_intf_pins ImageProcess_0/m_axis] [get_bd_intf_pins axis_dwidth_converter_0/S_AXIS]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins ImageProcess_0/s_axis] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins ImageProcess_0/axi_rst_n] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
...
# End of cr_bd_imageProcessSystem()
cr_bd_imageProcessSystem ""
set_property IS_MANAGED "0" [get_files imageProcessSystem.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files imageProcessSystem.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files imageProcessSystem.bd ] 
